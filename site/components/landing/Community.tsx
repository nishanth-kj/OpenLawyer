            ...
            <div className="container px-6 mx-auto">
                <div className="glass-card flex flex-col items-center gap-8 rounded-3xl p-12 text-center md:flex-row md:text-left">
                    <div className="flex-1">
                        <h2 className="mb-4 text-3xl font-bold tracking-tight text-foreground">Join the Open Law Movement</h2>
                        ...
                        <div className="flex flex-wrap gap-4 justify-center md:justify-start">
                            <Button asChild variant="secondary" className="rounded-full px-6">
                                <a href="https://github.com/nishanth-kj/OpenLawyer/issues" target="_blank">
                                    View Issues
                                </a>
                            </Button>
